...
**Superdiff** provides a rich and readable diff for **arrays**, **objects**, **text** and **coordinates**. It supports **stream** and file inputs for handling large datasets efficiently, is battle-tested, has zero dependencies, and offers a **top-tier performance**. 
